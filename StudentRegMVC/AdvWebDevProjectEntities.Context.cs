...
namespace StudentRegMVC
{
    ...
    public partial class AdvWebDevProjectEntities : DbContext
    {
        ...
        public DbSet<Class> ClassStudent { get; set; }
        public DbSet<LoginRequest> LoginRequests { get; set; }
        public DbSet<Student> Students { get; set; }
        public DbSet<vClass> vClasses { get; set; }
        public DbSet<vClassesByStudent> vClassesByStudents { get; set; }
        public DbSet<vClassStudent> vClassStudents { get; set; }
        public DbSet<vLoginRequest> vLoginRequests { get; set; }
        ...
        public virtual int pInsClasses(ObjectParameter classId, string className, Nullable<System.DateTime> classDate, string classDescription)
        {
            //var classIdParameter = classId.HasValue ?
            //    new ObjectParameter("ClassId", classId) :
            //    new ObjectParameter("ClassId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("pInsClasses", classId, classNameParameter, classDateParameter, classDescriptionParameter);
        }
